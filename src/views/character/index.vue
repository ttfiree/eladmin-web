    ...
    <div class="head-container">
      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="护甲值" prop="armorClass">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column prop="speed" label="移动速度" />
        <el-table-column v-if="checkPer(['admin','gameCharacter:edit','gameCharacter:del'])" label="操作" width="150px" align="center">
...
<script>
import crudGameCharacter from '@/api/gameCharacter'
...
const defaultForm = { id: null, userId: null, createTime: null, isDelete: null, extStringOne: null, extStringTwo: null, extStringThree: null, extStringFour: null, extStringFive: null, extDecimalOne: null, extDecimalTwo: null, extDecimalThree: null, extDecimalFour: null, extDecimalFive: null, name: null, class: null, level: null, experience: null, money: null, hitPoints: null, armorClass: null, speed: null }
export default {
  name: 'GameCharacter',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: 'character', url: 'api/gameCharacter', idField: 'id', sort: 'id,desc', crudMethod: { ...crudGameCharacter }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'gameCharacter:add'],
        edit: ['admin', 'gameCharacter:edit'],
        del: ['admin', 'gameCharacter:del']
      },
      rules: {
        userId: [
        ...
        armorClass: [
          { required: true, message: '护甲值不能为空', trigger: 'blur' }
        ],
        speed: [
